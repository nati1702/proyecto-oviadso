    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      ...
      <div className="w-full max-w-md bg-white shadow-lg rounded-xl p-8 border-t-4 border-orange-500">
        ...
        <form className="space-y-5">
          ...
          <div>
            <label htmlFor="mother_id" className="block text-sm font-semibold text-gray-700 mb-1">
              ID Madre:
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="number_of_offspring" className="block text-sm font-semibold text-gray-700 mb-1">
              Número de Crías:
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="type_of_birth" className="block text-sm font-semibold text-gray-700 mb-1">
              Tipo de Parto:
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="complications" className="block text-sm font-semibold text-gray-700 mb-1">
              Complicaciones:
            </label>
            <input
              type="text"
